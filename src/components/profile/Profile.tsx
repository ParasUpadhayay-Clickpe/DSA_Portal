...
export const Profile: React.FC = () => {
  ...
  const fetchAgentDetails = async () => {
    ...
    try {
      ...
      const isSuccess =
        (response.status === "Success" || response.message === "Success") &&
        response.response &&
      ...
      if (isSuccess) {
        ...
        const normalizedData: Partial<AgentDetails> = {
          ...
          contract_or_commission: data.contract_or_commission
            ? String(data.contract_or_commission)
            : "",
        };
        ...
        setError(
          `Failed to load profile: ${errorMsg}. Response: ${JSON.stringify(
            response
          )}`
        );
      }
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const updateData = {
        ...
        mname:
          agentData.mname && agentData.mname !== ""
            ? agentData.mname
            : undefined,
        lname:
        ...
        gender:
          agentData.gender && agentData.gender !== ""
            ? agentData.gender
            : undefined,
        home_address1:
          agentData.home_address1 && agentData.home_address1 !== ""
            ? agentData.home_address1
            : undefined,
        home_address2:
          agentData.home_address2 && agentData.home_address2 !== ""
            ? agentData.home_address2
            : undefined,
        home_district:
          agentData.home_district && agentData.home_district !== ""
            ? agentData.home_district
            : undefined,
        home_state:
          agentData.home_state && agentData.home_state !== ""
            ? agentData.home_state
            : undefined,
        home_pin_code:
          agentData.home_pin_code && agentData.home_pin_code !== ""
            ? agentData.home_pin_code
            : undefined,
        office_address1:
          agentData.office_address1 && agentData.office_address1 !== ""
            ? agentData.office_address1
            : undefined,
        office_address2:
          agentData.office_address2 && agentData.office_address2 !== ""
            ? agentData.office_address2
            : undefined,
        office_district:
          agentData.office_district && agentData.office_district !== ""
            ? agentData.office_district
            : undefined,
        office_state:
          agentData.office_state && agentData.office_state !== ""
            ? agentData.office_state
            : undefined,
        office_pin_code:
          agentData.office_pin_code && agentData.office_pin_code !== ""
            ? agentData.office_pin_code
            : undefined,
        pan: agentData.pan && agentData.pan !== "" ? agentData.pan : undefined,
        ifsc:
          agentData.ifsc && agentData.ifsc !== "" ? agentData.ifsc : undefined,
        acc_num:
          agentData.acc_num && agentData.acc_num !== ""
            ? agentData.acc_num
            : undefined,
        beneficiary_name:
          agentData.beneficiary_name && agentData.beneficiary_name !== ""
            ? agentData.beneficiary_name
            : undefined,
        fos_or_dsa:
          agentData.fos_or_dsa && agentData.fos_or_dsa !== ""
            ? agentData.fos_or_dsa
            : undefined,
        contract_or_commission:
          agentData.contract_or_commission &&
          agentData.contract_or_commission !== ""
            ? agentData.contract_or_commission
            : undefined,
      };
          ...
          <div className={styles.section}>
            ...
            <div className={styles.formGrid}>
              <Input
                ...
                onChange={(value) =>
                  handleInputChange("office_address1", value)
                }
                disabled={!isEditing}
                fullWidth
              />
              <Input
                ...
                onChange={(value) =>
                  handleInputChange("office_address2", value)
                }
                disabled={!isEditing}
                fullWidth
              />
              <Input
                ...
                onChange={(value) =>
                  handleInputChange("office_district", value)
                }
                disabled={!isEditing}
                fullWidth
              />
              ...
              <Input
                ...
                onChange={(value) =>
                  handleInputChange("office_pin_code", value)
                }
                disabled={!isEditing}
                fullWidth
              />
          ...
          <div className={styles.section}>
            ...
            <div className={styles.formGrid}>
              ...
              <Input
                ...
                onChange={(value) =>
                  handleInputChange("beneficiary_name", value)
                }
                disabled={!isEditing}
                fullWidth
              />
            ...
            <div className={styles.formGrid}>
              <div className={styles.selectWrapper}>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleInputChange("fos_or_dsa", e.target.value || undefined)
                  }
                  disabled={!isEditing}
                >
